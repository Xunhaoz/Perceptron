...
train_loader = DataLoader(data[:75], batch_size=BATCH_SIZE, one_hot_encode=False)
test_loader = DataLoader(data[-75:], batch_size=BATCH_SIZE, one_hot_encode=False)
...
mse, rmse, acc = train(test_loader, train=False)
